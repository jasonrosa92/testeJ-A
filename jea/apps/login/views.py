...
from jea.apps.base.views_mixins import SuperUserRequiredMixin

from .forms import UserLoginForm, UserRegistrationForm, PasswordResetForm, SetPasswordForm, PerfilUsuarioForm
from .models import Usuario
from jea.configs.settings import DEFAULT_FROM_EMAIL

from jea.apps.cadastro.forms.empresa import MinhaEmpresaForm
...
DEFAULT_PERMISSION_MODELS = ['cliente', 'produto','empresa', 'categoria', 'condicaopagamento', 
                             'orcamentovenda', 'pedidovenda','localestoque', 'movimentoestoque', ]

CUSTOM_PERMISSIONS = ['consultar_cadastro','faturar_pedidovenda', 'faturar_pedidocompra', 'acesso_fluxodecaixa', 'consultar_estoque', ]
