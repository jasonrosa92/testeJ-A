...
from jea.apps.base.custom_views import CustomCreateView, CustomListView, CustomUpdateView

from jea.apps.cadastro.forms.pessoa_forms import PessoaJuridicaForm, PessoaFisicaForm
from jea.apps.cadastro.forms.inline_formsets import EnderecoFormSet, TelefoneFormSet, EmailFormSet, SiteFormSet, DocumentoFormSet
from jea.apps.cadastro.models.base import PessoaFisica, PessoaJuridica, Endereco, Telefone, Email, Site, Documento
