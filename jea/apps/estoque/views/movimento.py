...
from jea.apps.base.custom_views import CustomDetailView, CustomCreateView, CustomListView

from jea.apps.estoque.forms.movimento import EntradaEstoqueForm, SaidaEstoqueForm, TransferenciaEstoqueForm, ItensMovimentoFormSet
from jea.apps.estoque.models.movimento import MovimentoEstoque, EntradaEstoque, SaidaEstoque, TransferenciaEstoque
